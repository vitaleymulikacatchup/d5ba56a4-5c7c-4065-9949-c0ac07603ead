...
export const metadata: Metadata = {
  title: "CineMax - Premium Movie Theater Experience | Book Tickets Online",
  description: "Experience cinema like never before at CineMax theaters. Premium screens, luxury seating, gourmet concessions. Book your movie tickets online today!",
  keywords: ["movie theater", "cinema tickets", "premium movies", "IMAX", "Dolby Atmos", "movie booking", "concessions", "VIP experience"],
  metadataBase: new URL("https://cinemax-theaters.com"),
  alternates: {
    canonical: "https://cinemax-theaters.com"
  },
  openGraph: {
    title: "CineMax - Premium Movie Theater Experience",
    description: "Experience cinema like never before with state-of-the-art theaters, gourmet concessions, and unforgettable entertainment.",
    url: "https://cinemax-theaters.com",
    siteName: "CineMax Theaters",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34kFQ1mvageIxtFsoHwjFOCooyh/uploaded-1763645893059-fjcbnqsh.jpg",
      alt: "CineMax premium theater interior"
    }],
    type: "website"
  },
  twitter: {
    ...
    title: "CineMax - Premium Movie Theater Experience",
    description: "Experience cinema like never before with state-of-the-art theaters and gourmet concessions.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34kFQ1mvageIxtFsoHwjFOCooyh/uploaded-1763645893059-fjcbnqsh.jpg"]
  },
  robots: {
    index: true,
    follow: true
